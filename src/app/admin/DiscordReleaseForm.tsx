  ...
  return (
    <div className="bg-[#12121a] border border-[#2a2a3d] rounded-2xl overflow-hidden">
      <div className="px-5 py-3 border-b border-[#2a2a3d] flex items-center gap-2">
        ...
        <span className="ml-auto text-xs text-[#555570]">Posts to #🎉changelog</span>
      </div>

      <form onSubmit={handleSubmit} className="p-6 space-y-5">
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="text-[#8888a8] text-xs font-semibold uppercase tracking-wider block mb-1.5">Version</label>
            <input
              value={version}
          ...
          <div>
            <label className="text-[#8888a8] text-xs font-semibold uppercase tracking-wider block mb-1.5">Release Title</label>
            <input
              value={title}
        ...
        <div>
          <label className="text-[#8888a8] text-xs font-semibold uppercase tracking-wider block mb-1.5">Features Shipped</label>
        ...
        <div>
          <label className="text-[#8888a8] text-xs font-semibold uppercase tracking-wider block mb-1.5">Additional Notes <span className="normal-case font-normal">(optional)</span></label>
          <textarea
            value={notes}
        ...
        {(version || title || features.some(f => f.trim())) && (
          <div className="bg-[#0a0900] border border-violet-500/20 rounded-xl p-4">
            ...
            <div className="border-l-4 border-violet-500 pl-3">
              ...
              {notes && <p className="text-[#8888a8] text-xs mt-2">{notes}</p>}
            </div>
          </div>
        )}
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-violet-600 hover:bg-violet-500 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-semibold px-5 py-2.5 rounded-lg transition-colors"
          >

    ...
    <div className="min-h-screen p-8" style={{ background: '#0a0900', color: '#dde4f0', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold" style={{ color: '#84cc16' }}>Ad Campaigns</h1>
            <p className="mt-2" style={{ color: '#b8a870' }}>Create and manage your ad campaigns</p>
          </div>
          <Link
            href="/campaigns/new"
        ...
        {campaigns && campaigns.length > 0 ? (
          <div className="grid gap-4">
            {campaigns.map((campaign: any) => (
              ...
              >
                ...
                <p className="mt-2" style={{ color: '#b8a870' }}>{campaign.description}</p>
                <div className="flex gap-6 mt-4 text-sm" style={{ color: '#b8a870' }}>
          ...
          <div className="text-center py-16">
            <p className="mb-4" style={{ color: '#b8a870' }}>No campaigns yet. Create your first one!</p>
            <Link
              href="/campaigns/new"

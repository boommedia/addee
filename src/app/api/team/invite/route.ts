      ...
      html: `
        <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:40px 32px;background:#060d1a;color:#dde4f0;border-radius:16px;">
          <div style="display:flex;align-items:center;gap:8px;margin-bottom:32px;">
            <div style="width:28px;height:28px;background:linear-gradient(135deg,#ef4444,#fb923c);border-radius:6px;font-weight:900;font-size:12px;color:white;display:flex;align-items:center;justify-content:center;">A</div>
          ...
          <a href="${joinUrl}" style="display:inline-block;background:linear-gradient(135deg,#ef4444,#dc2626);color:white;font-weight:600;font-size:15px;padding:14px 28px;border-radius:10px;text-decoration:none;margin-bottom:24px;">
            Accept Invitation →
          </a>

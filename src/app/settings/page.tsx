  ...
  return (
    <div className="min-h-screen" style={{ background: '#060d1a', color: '#dde4f0', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-10">
        <div className="mb-8">
          <h1 className="text-2xl font-bold mb-1" style={{ color: '#00FF00' }}>Settings</h1>
          <p className="text-sm" style={{ color: '#7a90b8' }}>Manage your team and account preferences.</p>
        </div>
        <div className="space-y-6">
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(11,22,40,0.6)', borderColor: 'rgba(0,102,255,0.3)', border: '1px solid' }}>
            <div className="px-5 py-3" style={{ borderBottomColor: 'rgba(0,102,255,0.2)', borderBottom: '1px solid' }}>
            ...
            <div style={{ borderColor: 'rgba(0,102,255,0.2)' }} className="divide-y">
              ...
              {[
                ...
                <a key={href} href={href} className="flex items-center gap-4 px-5 py-4 transition-colors group" style={{ background: 'transparent' }}>
                  ...
                  <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ background: 'rgba(0,102,255,0.1)', borderColor: 'rgba(0,102,255,0.3)', border: '1px solid' }}>{icon}</div>
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-medium" style={{ color: '#dde4f0' }}>{label}</div>
                    <div className="text-xs" style={{ color: '#7a90b8' }}>{desc}</div>
                  </div>
                  <ChevronRight className="w-4 h-4 transition-colors shrink-0" style={{ color: '#7a90b8' }} />
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(11,22,40,0.6)', borderColor: 'rgba(0,102,255,0.3)', border: '1px solid' }}>
            ...
            <div className="px-5 py-4 space-y-3">
              ...
              <a
                href="/api/gsc/oauth"
                className="inline-flex items-center gap-2 text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors" style={{ color: 'white', background: '#0066FF', border: 'none' }}
              >
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(11,22,40,0.6)', borderColor: 'rgba(0,102,255,0.3)', border: '1px solid' }}>
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              <p className="text-xs" style={{ color: '#7a90b8' }}>
                ...
                Tip: copy the <code style={{ color: '#7a90b8' }}>private_key</code> value from the downloaded JSON file exactly as-is â Vercel handles the multi-line string correctly.

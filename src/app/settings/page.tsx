    ...
    <div className="min-h-screen bg-[#0a0a0f] text-[#e8e8f0]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#8888a8] text-sm">Manage your team and account preferences.</p>
          ...
          <div className="bg-[#12121a] border border-[#2a2a3d] rounded-2xl overflow-hidden">
            ...
            <div className="divide-y divide-[#2a2a3d]">
              ...
              {[
                ...
                <a key={href} href={href} className="flex items-center gap-4 px-5 py-4 hover:bg-[#1a1a26] transition-colors group">

                  <div className="w-8 h-8 rounded-lg bg-[#1a1a26] border border-[#2a2a3d] flex items-center justify-center shrink-0">{icon}</div>

                  <div className="flex-1 min-w-0">

                    <div className="text-white text-sm font-medium">{label}</div>

                    <div className="text-[#8888a8] text-xs">{desc}</div>

                  </div>

                  <ChevronRight className="w-4 h-4 text-[#555570] group-hover:text-white transition-colors shrink-0" />
          ...
          <div className="bg-[#12121a] border border-[#2a2a3d] rounded-2xl overflow-hidden">
            ...
            <div className="px-5 py-4 space-y-4">
              ...
              <p className="text-[#555570] text-xs">
                ...
                Tip: copy the <code className="text-[#8888a8]">private_key</code> value from the downloaded JSON file exactly as-is â Vercel handles the multi-line string correctly.

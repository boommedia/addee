...
const FEATURES = [
  {
    icon: <Zap className="w-5 h-5" style={{ color: '#ca8a04' }} />,
  ...
  {
    icon: <Globe className="w-5 h-5" style={{ color: '#ca8a04' }} />,
  ...
  {
    icon: <Calendar className="w-5 h-5" style={{ color: '#ca8a04' }} />,
  ...
  {
    icon: <BarChart2 className="w-5 h-5" style={{ color: '#ca8a04' }} />,
  ...
  {
    icon: <Image className="w-5 h-5" style={{ color: '#ca8a04' }} />,
  ...
  {
    icon: <Video className="w-5 h-5" style={{ color: '#ca8a04' }} />,
    title: 'YouTube → Blog',
  ...
  {
    icon: <Link2 className="w-5 h-5" style={{ color: '#ca8a04' }} />,
    title: 'URL to Blog',
  ...
  {
    icon: <Target className="w-5 h-5" style={{ color: '#ca8a04' }} />,
  ...
  return (
    <div className="min-h-screen bg-[#0a0900] text-[#e8e8f0]">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10 space-y-12">
        {/* Hero */}
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#12121a] via-[#1a1226] to-[#0a0900] border border-[rgba(202,138,4,0.3)] px-8 py-12 sm:px-12">
          ...
          <div className="relative">
            ...
            <p className="text-[#b8a870] text-base max-w-xl mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="/clients"
                className="inline-flex items-center gap-2 bg-[#1a1a26] hover:bg-[#2a2a3d] border border-[rgba(202,138,4,0.3)] text-white font-semibold text-sm px-6 py-3 rounded-xl transition-colors">
                <Users className="w-4 h-4" /> Manage clients
              </a>
              <a href="/analytics"
                className="inline-flex items-center gap-2 bg-[#1a1a26] hover:bg-[#2a2a3d] border border-[rgba(202,138,4,0.3)] text-[#b8a870] hover:text-white font-semibold text-sm px-6 py-3 rounded-xl transition-colors">
              ...
              <div key={announcement.id} className={`rounded-2xl border p-4 ${announcement.type === 'feature' ? 'bg-gradient-to-r from-violet-500/10 to-cyan-500/10 border-violet-500/20' : 'bg-amber-500/5 border-amber-500/20'}`}>
                <div className="flex items-start gap-4">
                  <div className="flex-1">
                    ...
                    <p className="text-[#b8a870] text-xs mb-3">{announcement.description}</p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            <div key={stat.label} className="bg-[rgba(20,18,0,0.6)] border border-[rgba(202,138,4,0.3)] rounded-xl px-4 py-4">
              <div className="flex items-center gap-2 text-[#b8a870] text-xs mb-2">{stat.icon}{stat.label}</div>
        ...
        <div>
          <div className="mb-6">
            ...
            <p className="text-[#b8a870] text-sm">Manage all your client blogs — WordPress, Shopify, Webflow — in one place. Generate, publish, track, and scale.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {FEATURES.map(f => (
              ...
              >
                ...
                <p className="text-xs leading-relaxed mb-4" style={{ color: '#b8a870' }}>{f.description}</p>
                <span className="text-xs font-semibold flex items-center gap-1 transition-colors" style={{ color: '#84cc16' }}>
        ...
        <div>
          <div className="mb-6">
            ...
            <p className="text-[#b8a870] text-sm">Start with 2-5 clients. Grow to 40+. No lock-in. Upgrade anytime.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            {FEATURE_TIERS.map(tier => (
              <div key={tier.name} className="rounded-2xl border p-6" style={{ background: 'rgba(20,18,0,0.6)', borderColor: 'rgba(202,138,4,0.3)', border: '1px solid' }}>
                <div className="mb-4">
                  <h3 className="text-white font-bold text-lg">{tier.name}</h3>
                  <div className="text-sm font-semibold mt-1" style={{ color: '#84cc16' }}>{tier.price}</div>
                  <div className="text-xs mt-1" style={{ color: '#b8a870' }}>{tier.posts}</div>
                </div>
                <div className="space-y-3">
                  ...
                  {tier.locked.length > 0 && (
                    <>
                      <div className="border-t border-[rgba(202,138,4,0.3)] my-3" />
                      {tier.locked.map(feature => (
                        <div key={feature} className="flex items-start gap-2 opacity-50">
                          ...
                          <span className="text-[#b8a870] text-sm">{feature}</span>
                        </div>
                      ))}
                    </>
                  )}
                ...
                {(() => {
                  ...
                  if (tierLevel === currentLevel) {
                    return <div className="block w-full mt-6 py-2 px-4 rounded-lg bg-[#2a2a3d] text-[#b8a870] text-sm font-semibold text-center">Current Plan</div>
                  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6">
          {/* Recent posts */}
          <div className="bg-[rgba(20,18,0,0.6)] border border-[rgba(202,138,4,0.3)] rounded-2xl p-6">
            ...
            {(recentPosts ?? []).length === 0 ? (
              <div className="text-center py-10">
                ...
                <p className="text-[#b8a870] text-sm mb-3">No posts yet.</p>
              ...
              <div className="space-y-0">
                {(recentPosts ?? []).map(post => {
                  ...
                  const statusColors = isLive
                    ...
                    : 'text-[#b8a870] bg-[#1a1a26] border-[rgba(202,138,4,0.3)]'
          ...
          {isFreeOrStarter && (
            <div className="bg-gradient-to-br from-[#1a1226] to-[#12121a] border border-violet-500/20 rounded-2xl p-6 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-[#b8a870] text-sm mb-5">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <a key={action.href} href={action.href}
                    className="flex items-center gap-3 px-4 py-3 rounded-xl bg-[#1a1a26] hover:bg-[#2a2a3d] border border-[rgba(202,138,4,0.3)] hover:border-[#3a3a50] transition-colors group">
                    {action.icon}
        ...
        <div>
          <div className="mb-6">
            ...
            <p className="text-[#b8a870] text-sm">We're here to support you and your team every step of the way.</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {RESOURCES.map(resource => (
              <a key={resource.href} href={resource.href} target={resource.href.startsWith('http') ? '_blank' : undefined} rel={resource.href.startsWith('http') ? 'noopener noreferrer' : undefined}
                className="bg-[rgba(20,18,0,0.6)] border border-[rgba(202,138,4,0.3)] rounded-2xl p-6 hover:border-[#3a3a50] transition-all group">
                ...
                <p className="text-[#b8a870] text-xs mb-4 leading-relaxed">{resource.description}</p>
